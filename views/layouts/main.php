...
<header id="header">
    <?php
    NavBar::begin([
        'brandLabel' => '<img style="border-radius:20px;box-shadow: 0 0px 19px rgb(255,43,43);" src="images/logo.png" width="60px" class="img-responsive"/>',
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div style="font-size:20px;margin-top:30px" class="col-md-6 text-center text-md-start">&copy; Переверни-ка! <?= date('Y') ?></div>
        </div>
    </div>
</footer>
<style>
